...
// game constant
#define SPEED            1
#define GRAVITY         15  //9.8
#define JUMP_FORCE      1 //2.15
#define SKIP_TICKS     20   //20  // 1000 / 50fps
...
void game_start() {
  ...
  M5.Lcd.println("GoCovid-19");
  M5.Lcd.setCursor( TFTW2 - 40, TFTH2 + 21);
  M5.Lcd.println(" Please Blow");
  while (1) {
...
void game_over() {
  ...
  M5.Lcd.print("score: ");
  M5.Lcd.print(score);
  M5.Lcd.setCursor( 25, TFTH2 + 10);
  
  M5.Lcd.println("BLOW");
  M5.Lcd.setCursor( 5, TFTH2 + 20);
  M5.Lcd.println("FOR NEW GAME");
